...
<div class="ms-all-content ms-content-mobile-space pt-130">
    <main>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-xl-10 col-lg-10">
                            <div class="ms-about-content text-center">
                                <h2 class="ms-title2 white-text mb-30 bd-title-anim">KINGS GOLDEN PASS
                                </h2>
                            </div>
                        </div>
                    </div>
        ...
        <!-- about course start -->
        <section class="work__area work-overlay pt-130 pb-70 include__bg"
                        ...
                        <div class="ms-work3-thumb-wrap d-inline-block p-relative mb-60">
                            <div class="ms-work3-inner">
                                <div class="ms-work3-thumb m-img p-relative fix ms-br-20">
                                    ...
                                    <img src="{{ asset('assets/img/work/work-thumb-05.jpg') }}" alt="work image">
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-6 col-lg-10">
                        <div class="work__content-wrapper work__content-wrapper-space p-relative mb-4">
                    ...
                    <div class="col-lg-4">
                        <div class="ms-booking-item mb-25">
                            ...
                            <ul>
                                ...
                                <li>Our Extensive Range Of Courses.</li>
                    ...
                    <div class="col-lg-4">
                        <div class="ms-booking-item mb-25">
                            ...
                            <ul>
                                ...
                                <li>Acclaimed Dance Professionals.</li>
                    ...
                    <div class="col-lg-4">
                        <div class="ms-booking-item mb-25">
                            ...
                            <ul>
                                ...
                                <li>
                                    Community That Supports And Inspires.</li>
                    ...
                    <div class="col-xl-6 col-lg-10">
                        <div class="work__content-wrapper p-relative mb-60">
                            <div class="section__title-wrapper mb-50">
                                <h2 class="section__title mb-40 bd-title-anim">Career Opportunities<span class="text-bg"></span></h2>

                                <span class="section__subtitle">Dance Instructor:</span>
                                <p>Get A Chance To Become A Dance
                                    Instructor At King's Dance Studio.</p>

                                <span class="section__subtitle">Management Team:</span>
                                <p>Opportunities To Work Behind
                                    The Scenes With The Management Team.</p>
                                <span class="section__subtitle">Perform With The Champions:</span>
                                <p>

                                    Showcase Your Talent And Perform
                                    Perform Alongside The Champions,
                                    The Kings.
                                </p>
                            </div>
