                    ...
                    <div class="row justify-content-center">
                        <div class="col-xl-10 col-lg-10">
                            <div class="ms-about-content text-center">
                                <h2 class="ms-title2 white-text mb-30 bd-title-anim">CHOREO LAB
                                </h2>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="work__features-inner">
                                    <div class="work__features-item">
                                        ...
                                        <div class="work__features-content">
                                            <h4>Schedule: Every Sunday | 6 PM - 9 PM
                                    ...
                                    <div class="work__features-item">
                                        ...
                                        <div class="work__features-content">
                                            <h4>Duration: 3 Hours / Session</h4>
                                    ...
                                    <div class="work__features-item">
                                        ...
                                        <div class="work__features-content">
                                            <h4>Total: 12 Hours of Training / Month</h4>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-xl-12">
                            <div class="ms-work-system-inner text-center">
                                <span class="section__subtitle">Breakdown</span>
                    ...
                    <div class="col-lg-6">
                        <div class="ms-booking-item mb-25 custome-border">
                            ...
                            <ul>
                                ...
                                <li>Monthly Dance Visual Shoots</li>
                                <li>Individual Growth</li>
                                <li>Teamwork Skills</li>
                                <li>Future industry exposure</li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="ms-booking-item mb-25 custome-border">
                            ...
                            <ul>
                                <li>
                                    ...
                                    To train you like a professional, test your growth monthly,

                                </li>
                                <li>Help you step into the dance industry with
                                    confidence, clarity and unmatched preparation.</li>
                            </ul>
                    ...
                    <div class="col-lg-6">
                        <div class="ms-booking-item mb-25 custome-border">
                            ...
                            <ul>
                                ...
                                <li>
                                    Respect time, discipline and your fellow dancers</li>
                                <li>Give your all - in training, in rehearsal and on camera
                                </li>
                                <li>Take feedback seriously. Grow relentlessly</li>
                                <li>
                                    Treat this not just as a class, but as a launchpad</li>
                            </ul>
            ...
            <div class="container">
                <div class="ms-work-system-wrap">
                    <div class="row justify-content-center">
                        <div class="col-xl-12">
                            <div class="ms-work-system-inner text-center">
                                <h2 class="section__title mb-40 bd-title-anim">Payment Module<span class="text-bg"></span></h2>
                            </div>
                            <div class="row mb-45 bdFadeUp">
                                ...
                                <div class="col-xl-4 col-md-6">
                                    <div class="ms-choose-item mb-25">
                                        ...
                                        <h3 class="ms-choose-title">Next 10 Seats
                                        </h3>
                                        <p>Rs. 2500 (Limited Availability)</p>
                                    </div>
                                </div>
                                <div class="col-xl-4 col-md-6">
                                    <div class="ms-choose-item mb-25">
                                        ...
                                        <h3 class="ms-choose-title">General Enrollment </h3>
                                        <p>Rs. 3000 (Open Until Full)</p>
                                    </div>
                                </div>
                            </div>
                            <!-- <div class="trending-btn d-flex justify-content-center">
