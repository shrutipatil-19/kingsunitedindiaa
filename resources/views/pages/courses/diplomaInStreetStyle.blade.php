                    ...
                    <div class="row justify-content-center">
                        <div class="col-xl-10 col-lg-10">
                            <div class="ms-about-content text-center">
                                <h2 class="ms-title2 white-text mb-30 bd-title-anim">DIPLOMA IN STREET DANCE
                                </h2>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="work__content-wrapper p-relative mb-60">
                            <div class="section__title-wrapper mb-50">
                                ...
                                <p class="">Diploma In Street Styles Is A 4-month Certified Dance
                                    ...
                                    Authentic Street Styles. With 80 Intensive Sessions
                                    Covering 8 Dynamic Styles, This Course Takes You
                                    From Foundational Movements To Advanced Level
                                    Execution. The Program Also Includes
                                    Masterclasses, Battles, Competition Exposure And
                                    Performance Opportunities With Global Artists
                                    Such As The Kings.</p>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-xl-12">
                            <div class="ms-work-system-inner text-center">
                                <span class="section__subtitle">Details Of course</span>
                                <h2 class="section__title mb-40 bd-title-anim">Program Details <span class="text-bg"></span></h2>
                            </div>
                            <div class="ms-work-system-grid mb-10">
                                ...
                                <!-- <div class="work__features-item">
                                    ...
                                    <div class="work__features-content">
                                        <h4>Exposure To Battles, Competitions, And Event Auditions</h4>
                            ...
                            <!-- <div class="ms-work-system-inner text-center">
                                <ul>
                                    <li>Daily Training: 2 Hrs + 2 Hrs
                                        Addittional Practice Space</li>
                                    <li>Duration: 4 Months</li>
                                    <li>Styles: 8 Street Dance Styles
                                        (10 Sessions Per Style)
                                    </li>
                                    <li>2 Masterclasses With Industry
                                        Experts</li>
                                    <li>Certification Upon Completion</li>
                                    <li>Opportunities To Perform
                                        With Global Artists</li>
                                    <li>Exposure To Battles, Competitions,
                                        And Event Auditions</li>
                                </ul>
            ...
            <div class="container">
                <div class="row align-items-center bdFadeUp">
                    ...
                    <div class="col-xl-6 col-lg-10">
                        <div class="work__content-wrapper p-relative mb-60">
                            <div class="section__title-wrapper mb-50">
                                <h2 class="section__title mb-40 bd-title-anim">What we Offer you<span class="text-bg"></span></h2>

                                <span class="section__subtitle">Masterclass</span>
                                <p>Two Exclusive Masterclasses Conducted By
                                    Top Industry Professionals Focusing On
                                    Performance Execution Style Refinement And
                                    Professional Insights.</p>

                                <span class="section__subtitle">Certification</span>
                                <p>All Students Will Receive A Completion Certificate.
                                    Top Performers Will Have A Chance To Perform With Global
                                    Artists From The Kings, As Well As Exposure To Battles,
                                    Dance Competitions & Auditions For Events And Showcases.</p>
                            </div>
                        ...
                        <div class="col-xl-12">
                            <div class="ms-work-system-inner text-center">
                                ...
                                <h2 class="section__title mb-40 bd-title-anim">One - Time Payment :
                                    ₹38,000 <span class="text-bg"></span></h2>
                            </div>
...
<script>
    $(document).ready(function() {
        // initially show only the first 4
        $(".ms-booking-item").hide();
        $(".ms-booking-item").slice(0, 4).show();

        $(".ms-load-btn").click(function(e) {
            e.preventDefault();
            // show 4 more each time
            $(".ms-booking-item:hidden").slice(0, 2).slideDown();

            // optionally hide the button if all are shown
            if ($(".ms-booking-item:hidden").length == 0) {
                $(".ms-load-btn").fadeOut();
            }
        });
    });
