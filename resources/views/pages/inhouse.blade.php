...
<div class="ms-all-content ms-content-mobile-space pt-140">
    <main class="bg-w-3">
        ...
        <section class="production-section work__area pt-90 pb-45">
            <div class="container">
                <div class="position-relative">
                    ...
                    <div class="production-content section__title-wrapper mb-50 ms-bg-2">
                        <h2 class="section__title mb-40 bd-title-anim">Production</h2>
                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quaerat porro asperiores, et dolore mollitia, possimus nostrum numquam, sapiente esse quo incidunt optio doloremque minus.</p>
                        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Aliquam numquam debitis quos recusandae repellat, nulla rerum placeat a nemo deserunt esse mollitia adipisci.</p>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="production-section work__area pt-90 pb-45">
            <div class="container">
                <div class="position-relative">
                    <div class="production-content reverse-content section__title-wrapper mb-50 ms-bg-2">
                        <h2 class="section__title mb-40 bd-title-anim">Post Production</h2>
                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quaerat porro asperiores, et dolore mollitia, possimus nostrum numquam, sapiente esse quo incidunt optio doloremque minus.</p>
                        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Aliquam numquam debitis quos recusandae repellat, nulla rerum placeat a nemo deserunt esse mollitia adipisci.</p>
                    </div>
                    <div class="production-img end-img">
                        <img src="{{ asset('assets/img/kings crew/4.jpg') }}" alt="Production Image">
                    </div>
                </div>
            </div>
        ...
        <!-- Editor area start -->
        <section class="work__area pt-100 pb-30 bg-w-3">
            <div class="container">
                <div class="row align-items-center bdFadeUp">
                    <div class="col-xl-6 col-lg-10">
                        <div class="work__content-wrapper p-relative mb-60">
                            <div class="section__title-wrapper mb-50">
                                <h2 class="section__title mb-40 bd-title-anim text-black-custome">Editor <span class="text-bg"> </span></h2>
                                <p class="text-black-custome">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quaerat porro asperiores, et dolore mollitia, possimus nostrum numquam, sapiente esse quo incidunt optio doloremque minus. Accusantium culpa nihil autem corporis neque sequi. Dolorem sint libero obcaecati dolorum voluptate nemo, ipsam asperiores.
                                </p>
                                <p class="text-black-custome">Lorem ipsum dolor sit amet consectetur adipisicing elit. Aliquam numquam debitis quos recusandae repellat, nulla rerum placeat a nemo deserunt esse mollitia adipisci, modi assumenda, labore non est accusantium quae consectetur et. Illum, a laudantium.</p>
            ...
            <div class="container">
                <div class="row align-items-center bdFadeUp">
                    <div class="col-xl-6 col-lg-10">
                        <div class="work__content-wrapper p-relative mb-60">
                            <div class="section__title-wrapper mb-50">
                                <h2 class="section__title mb-40 bd-title-anim text-black-custome">Direction <span class="text-bg"> </span></h2>
                                <p class="text-black-custome">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quaerat porro asperiores, et dolore mollitia, possimus nostrum numquam, sapiente esse quo incidunt optio doloremque minus. Accusantium culpa nihil autem corporis neque sequi. Dolorem sint libero obcaecati dolorum voluptate nemo, ipsam asperiores.
                                </p>
                                <p class="text-black-custome">Lorem ipsum dolor sit amet consectetur adipisicing elit. Aliquam numquam debitis quos recusandae repellat, nulla rerum placeat a nemo deserunt esse mollitia adipisci, modi assumenda, labore non est accusantium quae consectetur et. Illum, a laudantium.</p>
                                <!-- <div class="work__features-btn ms-work3-feature-btn">
