...
<div class="ms-all-content ms-content-mobile-space pt-130">
    ...
    <section class="trending__area p-relative fix pt-90 bg-w-3 pb-130">
            <!-- text -->
            ...
            <div class="row align-items-end mb-25 bdFadeUp ">
                <div class="col-lg-8">
                    <div class="section__title-wrapper mb-40 bd-title-anim">
                        ...
                        <h2 class="section__title text-black-custome"><span class="animated-underline active">Kings Dance Studio: </span>
                ...
                <div class="swiper-container ms-trending-active">
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide">
                            <div class="ms-trending2-item fix">
                                <div class="ms-trending2-overlay p-absolute"></div>
                                <span class="trending__title">Our Services</span>
                        ...
                        <div class="swiper-slide">
                            ...
                            <a href="{{ route('creatorSpace') }}">
                                <div class="ms-trending2-item fix">
                                    <div class="ms-trending2-overlay p-absolute"></div>
                                    <span class="trending__title">Dance Studio</span>
                                    <!-- <div class="trending__price">
                                        <span>From $55</span>
                                    </div> -->
                                    <div class="ms-trending2-img w-img custome-h">
                        ...
                        <div class="swiper-slide">
                            <a href="{{ route('theKings') }}">
                                <div class="ms-trending2-item fix">
                                    <div class="ms-trending2-overlay p-absolute"></div>
                                    <span class="trending__title">Kings Production</span>
                                    <!-- <div class="trending__price">
                                        <span>From $90</span>
                                    </div> -->
                                    <div class="ms-trending2-img w-img custome-h">
    ...
    <!-- main page area start -->
        ...
        <!--achievements start  -->
        <section class="ms-choose-area pt-125 pb-105 ms-bg-2 include__bg p-relative zindex-1 d-none" style="background-image: url('{{ asset('assets/img/kings crew/5.jpg')}}');background-attachment: fixed;">
        ...
        <section class="ms-work-system-area pt-130 pb-130 d-none">
            <div class="container">
