                    ...
                    <div class="row justify-content-center">
                        <div class="col-xl-10 col-lg-10">
                            <div class="ms-about-content text-center">
                                <h2 class="ms-title2 white-text mb-30 bd-title-anim">STUDIO 3 Full
                                </h2>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-xl-8 col-lg-12">
                            <div class="ms-event-details-content mb-40">
                                ...
                                <div class="ms-border2 pb-20 mb-30">
                                    <h2 class="ms-event-dtitle">Studio 3 Full</h2>
                                </div>
                                <p class="mb-25">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Nulla exercitationem ut eius nesciunt tenetur aspernatur repudiandae deleniti reprehenderit reiciendis, atque id culpa, recusandae laudantium hic.</p>
                                <p class="mb-35">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Quaerat rerum dolorum, dignissimos quo deserunt nobis minus beatae iste vero nostrum consequuntur doloremque perspiciatis quis, voluptatem eaque corporis unde magni, recusandae maiores at deleniti necessitatibus! Harum.</p>
                            ...
                            <div class="ms-event-sidebar mb-60">
                                ...
                                <div class="ms-event-sidebar-item">
                                    <div class="ms-event-sidebar-inner">
                                        ...
                                        <span class="ms-event-stext">Full</span>
                                    </div>
                                    <div class="ms-event-sidebar-inner">
                                        <h4 class="ms-event-title2">Charge per hour</h4>
                                        <span class="ms-event-stext">INR 4000/HOUR</span>
                                    </div>
                                    <div class="ms-event-sidebar-inner">
                                        <h4 class="ms-event-title2">Shift Charge</h4>
                                        <span class="ms-event-stext">INR 11000 (3 HOUR SHIFT)</span>
                                    </div>
                                    <div class="ms-event-sidebar-inner">
