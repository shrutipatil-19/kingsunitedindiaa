                ...
                <div class="row w-100">
                    <div class="col-lg-6">
                        <div class="section__title-wrapper">
                            ...
                            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Nemo cupiditate ut necessitatibus in ratione reprehenderit magnam eum porro, ipsa libero aperiam itaque voluptates deleniti. Distinctio assumenda unde nisi atque. Numquam!
                            </p>
                            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Aspernatur sit amet vero debitis nulla quae omnis, nobis mollitia! Quas quae perferendis voluptatum odit atque deleniti officia ea laborum! Nam molestias eaque magnam odit fugit accusamus eos excepturi, maxime sint neque!</p>
                        </div>
                    </div>
                    <div class="col-lg-6">
                ...
                <div class="row w-100">
                    <div class="col-lg-6">
                        <div class="section__title-wrapper">
                            ...
                            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Incidunt cumque minima laboriosam dolorum facere, iure eveniet magnam sed, illum voluptatum vero debitis non accusamus pariatur deserunt est beatae commodi enim perspiciatis quidem ut nostrum neque minus? Nesciunt, tempora! Odio, modi.</p>
                            <p class="">
                                Lorem ipsum, dolor sit amet consectetur adipisicing elit. Error, ipsa Lorem ipsum dolor sit, amet consectetur adipisicing elit. Reiciendis suscipit natus id sit a, necessitatibus facilis praesentium fugit dolor dolorum?.</p>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <!-- <div class="work__thumb m-img">
                ...
                <div class="row w-100">
                    <div class="col-lg-6">
                        <div class="section__title-wrapper ">
                            ...
                            <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Itaque fugiat quasi quidem minus repudiandae explicabo minima, totam quos nihil reiciendis! Dignissimos beatae quasi dolorem incidunt illo alias quibusdam nesciunt excepturi! Itaque, porro optio similique deserunt alias nobis numquam labore rerum?</p>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <!-- <div class="work__thumb m-img">
        ...
        <section class="hero kings-parallax bg-w-1">
            <div class="container text-center">
                ...
                <p class="text-black-custome" style="max-width: 800px; margin: 0 auto; font-size: 1.2rem; font-weight: 300;">
                    The Kings are not just dancers—they're storytellers, dreamers, and pioneers of Indian hip-hop on a global stage.
                    Rising from humble beginnings under the guidance of Suresh Mukund, they've become the symbol of passion, precision,
