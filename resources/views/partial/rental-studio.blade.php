          ...
          <div class="swiper achievementSwiper pt-lg-5 ms-trending3-wrap bdFadeUp">
              <div class="swiper-wrapper pt-lg-4">
                  ...
                  <div class="swiper-slide ms-trending3-item p-relative fix mb-40">
                      ...
                      <div class="ms-trending3-content">
                          <h3 class="ms-trending3-title mb-25"><a href="{{ route('studio.book.form', ['studio' => 'studio-2']) }}">STUDIO 2 - 750 SQ.FT</a></h3>
                  ...
                  <div class="swiper-slide ms-trending3-item p-relative fix mb-40">
                      ...
                      <div class="ms-trending3-content">
                          <h3 class="ms-trending3-title mb-25"><a href="{{ route('studio.book.form', ['studio' => 'studio-3']) }}">STUDIO 3A- 650 SQ.FT</a></h3>
                  ...
                  <div class="swiper-slide ms-trending3-item p-relative fix mb-40">
                      ...
                      <div class="ms-trending3-content">
                          <h3 class="ms-trending3-title mb-25"><a href="{{ route('studio.book.form', ['studio' => 'studio-4']) }}">STUDIO 3B- 650 SQ.FT</a></h3>
                  ...
                  <div class="swiper-slide ms-trending3-item p-relative fix mb-40">
                      ...
                      <div class="ms-trending3-content">
                          <h3 class="ms-trending3-title mb-25"><a href="{{ route('studio.book.form', ['studio' => 'studio-5']) }}">STUDIO 3 FULL</a></h3>
                          <p class="ms-trending3-text">Lorem ipsum dolor sit amet consectetur adipisicing elit. Eos, harum eligendi! Dolorum!
                          </p>
                      </div>
                  </div>
